...
from utils.fetch_data import hit_url, fetch_data, fetch_data_json
...
if __name__ == "__main__":
    ...
    characters = film_data.characters
    pool = ThreadPool(5)
    characters = pool.map(fetch_data, characters)
    characters = parse_obj_as(List[Characters_], characters)
    breakpoint()
